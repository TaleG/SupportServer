...
from app.models import Role_Permissions_Models
from app.utils import RET, DB_Console
from app import db

class Role_Permissions_Views(Resource, DB_Console):
    def __init__(self):
        super(Role_Permissions_Views, self).__init__(Database=Role_Permissions_Models)
