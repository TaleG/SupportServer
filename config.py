...
class Config(object):
    ...
    # 连接数据库
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:123456@192.168.66.100:3306/SupportServer"
    ...
    PERMANENT_SESSION_LIFETIME = 3600  # 设置session数据有效期，单位是秒
